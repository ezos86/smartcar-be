...
var user_resources = {
    ...
    addUser: function (user) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            services_1.default.knex('users').insert(user).then(function (response) {
                return response;
            }).catch(function (error) {
                return error;
            });
    ...
    removeUser: function (user_id) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            services_1.default.knex('users').where('id', user_id).del().then(function (response) {
                return response;
            }).catch(function (error) {
                return error;
            });
...
exports.default = user_resources;
//# sourceMappingURL=users.resources.js.map